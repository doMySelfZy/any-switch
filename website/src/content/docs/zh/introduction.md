---
title: 简介
description: XiaoBaiSwitch 以站点为中心，把上游 API 接到 Claude Code、Codex 和 Pi。
order: 1
---

**XiaoBaiSwitch** 是一个桌面应用：小白也能上手，用「上游站点」驱动 Claude Code、Codex 和 Pi 的配置。
...
2. **应用中心**：Claude Code、Codex 与 Pi 各有专用表单
