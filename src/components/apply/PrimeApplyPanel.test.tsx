...
import { PrimeApplyPanel } from "./PrimeApplyPanel";
import "@/i18n";
...
describe("PrimeApplyPanel", () => {
  ...
  it("hydrates model count and sends the Prime-specific request", async () => {
    render(
      <ConfigProvider>
        <AntdApp>
          <PrimeApplyPanel />
