...
export const PiApplyPanel = memo(function PiApplyPanel() {
  ...
  const { preset, setPreset, loading: presetLoading } = useThinkingPreset(siteId, "pi");
  ...
  const handleApply = async () => {
    ...
    try {
      ...
      await saveSiteThinkingPreset({ ...preset, siteId: site.id, target: "pi" });
